...
module.exports = {
    ...
    async startFlow(interaction) {
        ...
        return interaction.reply({ content: '👤 設定対象のユーザーを選択してください。', components: [row], flags: 64 });
    },
    ...
    async showTierSelect(interaction) {
        return autoInteractionTemplate(interaction, {
            ...
            async run(interaction) {
                ...
                const targetUser = await interaction.guild.members.fetch(targetUserId).catch(() => ({ displayName: '不明なユーザー' }));

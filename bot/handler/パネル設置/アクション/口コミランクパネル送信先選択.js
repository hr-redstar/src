        ...
        return interactionTemplate(interaction, {
            ...
            async run(interaction) {
                ...
                if (ok) {
                    ...
                    await interaction.followUp({ content: `✅ <#${channel.id}> に口コミランクパネルを設置しました。`, flags: MessageFlags.Ephemeral });
                } else {
                    await interaction.followUp({ content: `❌ 口コミランクパネルの送信に失敗しました。`, flags: MessageFlags.Ephemeral });
                }
            }
        });
    }

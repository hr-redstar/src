...
module.exports = {
    customId: 'ps:select:driverRegPanelChannel',
    type: 'channelSelect',
        ...
        return interactionTemplate(interaction, {
            ...
            async run(interaction) {
                ...
                if (ok) {
                    ...
                    await interaction.followUp({ content: `✅ <#${channel.id}> に送迎者登録パネルを設置しました。`, flags: MessageFlags.Ephemeral });
                } else {
                    await interaction.followUp({ content: `❌ 送迎者登録パネルの送信に失敗しました。`, flags: MessageFlags.Ephemeral });
                }
            }
        });
    },

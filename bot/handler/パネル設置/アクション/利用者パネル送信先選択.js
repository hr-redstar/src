...
module.exports = {
    customId: 'ps:select:userPanelChannel',
    type: 'channelSelect',
        ...
        return interactionTemplate(interaction, {
            ...
            async run(interaction) {
                ...
                if (ok) {
                    ...
                    await interaction.followUp({ content: `✅ <#${channel.id}> に利用者パネルを設置しました。`, flags: MessageFlags.Ephemeral });
                } else {
                    await interaction.followUp({ content: `❌ 利用者パネルの送信に失敗しました。`, flags: MessageFlags.Ephemeral });
                }
            }
        });
    },

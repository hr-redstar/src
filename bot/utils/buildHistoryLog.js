...
function buildHistoryLog(historyData, role = 'driver') {
    ...
    const oldRegisteredAt = historyData.oldRegisteredAt ? new Date(historyData.oldRegisteredAt).toLocaleString('ja-JP') : '不明';
    const changedAt = historyData.changedAt ? new Date(historyData.changedAt).toLocaleString('ja-JP') : '不明';
